...
<div class="mainContainer">
    <ul>
    	<li class="menuCont">
            <ul class="menu">
                <li class="logo"><img src="images/logo.png" title="Gumpaway.com" /></li>
                <li><a href="http://gumpaway.com/blog/" target="_self">BLOG</a></li>
                <li><a href="https://www.flickr.com/photos/91279587@N06/" target="_blank">FLICKR</a></li>
                <li><a href="https://cause2give.unxvision.com/P2PWeb/Default.aspx?EventId=1111&LanguageId=1" target="_blank">DONATE</a></li>
            </ul>	
        </li>
        <li class="contentCont">
            <ul class="content">
                ...
                <li class="raceHighlites">
                    July 21st 2016 1000am | Vancouver - Halifax | 6000km | 30 - 45 days
                </li>
