        ...
        <li class="contentCont">
            <ul class="content">
                ...
                <li class="raceHighlites">
                    July 15th 2016 0700am | Vancouver - Halifax | 6200km | 30 - 45 days
                </li>
        	...
        	<ul>
                <li class="upcomingRaces">
                    ...
                    <ul>
                        ...
                        <li class="raceName">Bike and Run Across Canada - Vancouver to Halifax 6200km</li>
                        <li class="link"><a href="">More info</a></li>
                    </ul>
                    <ul>
                        <li class="date">February 3rd 2017</li>
                        <li class="raceName">Yukon Arctic Ultra 300 miles</li>
