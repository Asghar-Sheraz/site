...
<div id="overview" class="mainContainer"  style="display:<? echo $content ?>;">
    ...
    <div class="levelOne">
            <ul class="tool_ul">
                ...
                <li class="tool_li"><img src="images/about/mudBox_Icon.png"  title="Autodesk Mudbox" /> <p><? echo htmlspecialchars($mudbox) ?></p></li>
           </ul>
    </div>
    <div id="theWork" class="levelThree">
        <div class=video >
			<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/281866668?h=f4319a7663&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="TNMT 80s THEME - 2017"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
			</div>
        </div>
    ...
    <div class="levelFour">
 		<div>
            ...
            <p><? echo htmlspecialchars($vidDesc_tnmt) ?></p>  
