...
if ($vidID == "mark6"){
	...
	$vid = "https://player.vimeo.com/video/285203433?title=0&byline=0&portrait=0";
...
if ($vidID == "zackManual"){
	$vidThumb = "haloLapsex.jpg";
	$vid = "https://player.vimeo.com/video/441221681?title=0&byline=0&portrait=0";
	$isActive_P3 = "isActive";
	$x = "-434px"; // this var moves the pager to the location of the js position selector
	$vidTitle = $vidTitle_zackManual;
	$vidDesc = $vidDesc_zackManual;
	$haloLapseDisplay = "none";
	$vimeoLink = "https://vimeo.com/441221681";
	$hideVimeoBTN = "block";
	$flashbanners ="none";
}		
?>
			...
			<li style="display: <? echo $fumeTrackingDisplay ?>;">
				<p>
					<a href="videoLoader.php<? echo $globalLink ?>&vid_ID=fumeTracking">
						<img src="images/videoImgContent/vid_thumb_fumeTracking.jpg" alt="<? echo $vidTitle_fumeTracking ?>"/>
					</a>
			...
			<li style="display: <? echo $minionDisplay ?>;">
				<p>
					<a href="videoLoader.php<? echo $globalLink ?>&vid_ID=minion">
						<img src="images/videoImgContent/vid_thumb_minion.jpg" alt="<? echo $vidTitle_minion ?>"/>
					</a>
			...
			<li style="display: <? echo $destinyTVCDisplay ?>;">
				<p>
					<a href="videoLoader.php<? echo $globalLink ?>&vid_ID=destinyTVC">
						<img src="images/videoImgContent/vid_thumb_destinyTVC.jpg" alt="<? echo $vidTitle_destinyTVC ?>"/>
					</a>
