...
<div  class="mainContainer">
    ...
    <div class="projectContainer_2">
		<ul>
        	<li class="list_2"><a class="linkAnim about" href="about.php?language=<? echo $langID ?>"><h2 class="title_about"><? echo htmlspecialchars($about) ?></h2></a></li>
        	<li class="list_2"><a class="linkAnim lab" href="lab.php?language=<? echo $langID ?>"><h2 class="title_lab"><? echo htmlspecialchars($lab) ?></h2></a></li>
        	<li class="list_2"><a class="linkAnim contact" href="contact.php?language=<? echo $langID ?>"><h2 class="title_contact"><? echo htmlspecialchars($contact) ?></h2></a></li>
        </ul>
    </div>
