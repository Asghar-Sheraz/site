...
<title>Gumpaway Contact - Make A Wish</title>
...
<div class="mainContainer">
    <ul>
        ...
        <li class="contentCont">
            <ul class="content" style="min-height:900px;">
                <li>
                    <h1 class="contactMe">sheraz@gumpaway.com</h1>
                </li>
                <li class="raceHighlites" style="background:none;">
                    montreal.canada
                </li>
            </ul>
        </li> 
